    ...
    <form action="{{ route('admin.pasien.store') }}" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div>
                ...
                <input type="tel" name="contact_number" id="contact_number" value="{{ old('contact_number') }}" placeholder="Contoh: 08123456789"
            ...
            <div >
                ...
                <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="pasien@example.com"
            ...
            <div class="md:col-span-2">
             ...
             {{-- Tambahkan field lain jika perlu (Riwayat Medis Awal, dll.) --}}
