...
@section('title', 'Tambah Akun Pasien Baru')
@section('page-title', 'Formulir Tambah Akun Pasien')

@section('content')
<div class="bg-white rounded-xl shadow p-6 md:p-8 border border-gray-200">
    <h2 class="text-xl font-semibold text-gray-800 mb-6">Buat Akun Login Baru untuk Pasien</h2>
